...
$string['confirmactivate'] = '<p>This will make your badge visible to users and allow them to start earning it.</p>
...
<p>Are you sure you want to enable access to \'{$a}\' badge(s)?</p>';
